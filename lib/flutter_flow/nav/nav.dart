      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => BluetoothWidget(
            ...
            displayDevices: params.getParam(
              'displayDevices',
              ParamType.DataStruct,
              isList: false,
              structBuilder: BTDeviceStruct.fromSerializableMap,
            ),
            displayAvailableDevices: params.getParam(
        ...
        FFRoute(
          ...
          path: '/vehicalStatus',
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'Vehical_status')
              : VehicalStatusWidget(),
        ),
        FFRoute(
          name: 'Splashpage',
        ...
        FFRoute(
          name: 'BluetoothDevicePage',
          path: '/bluetoothDevicePage',
          builder: (context, params) => BluetoothDevicePageWidget(
        ...
        FFRoute(
          name: 'chatui',
          path: '/chatui',
          builder: (context, params) => ChatuiWidget(),
        )
